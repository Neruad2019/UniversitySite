...
<div class="card text-center">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="javascript:;" onclick="document.getElementById('ToScheduleMonday').submit();">Monday</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="javascript:;" onclick="document.getElementById('ToScheduleFriday').submit();">Friday</a>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <blockquote class="blockquote mb-0">
                    ...
                    <footer class="blockquote-footer">Assistant-Professor: Anuar Esbergenov</footer>
                </blockquote>
            </div>
        </div>
        <div class="card mb-4">
            ...
            <div class="card-body">
                <blockquote class="blockquote mb-0">
                    <p>Physics</p>
                    <footer>202 room</footer>
                    <footer class="blockquote-footer">Assossiated-Professor: Askar Bebitov</footer>
                </blockquote>
            </div>
        </div>
    <div class="card mb-4">
